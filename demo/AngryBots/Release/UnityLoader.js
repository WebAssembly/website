    ...
    return function e(t, n, o) {
        ...
        7: [
            function(e, t, n) {
                ...
                t.exports = function(e, t) {
                    var n, a, r, s, l, d, u, c, f, h, m, p, b, w, g, v, k, y, _, S, x, M, C, E, D;
                    n = e.state, a = e.next_in, E = e.input, r = a + (e.avail_in - 5), s = e.next_out, D = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, m = n.window, p = n.hold, b = n.bits, w = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
                    e: do {
                    ...
                    S = b >> 3, a -= S, b -= S << 3, p &= (1 << b) - 1, e.next_in = a, e.next_out = s, e.avail_in = r > a ? 5 + (r - a) : 5 - (a - r), e.avail_out = d > s ? 257 + (d - s) : 257 - (s - d), n.hold = p, n.bits = b
                }
            }, {}
        ],
        8: [
            function(e, t, n) {
                ...
                function a(e) {
                    var t;
                    return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = O, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(me), t.distcode = t.distdyn = new w.Buf32(pe), t.sane = 1, t.back = -1, D) : A
                }
                ...
                function s(e, t) {
                    var n, o;
                    return e && e.state ? (o = e.state, 0 > t ? (n = 0, t = -t) : (n = (t >> 4) + 1, 48 > t && (t &= 15)), t && (8 > t || t > 15) ? A : (null !== o.window && o.wbits !== t && (o.window = null), o.wrap = n, o.wbits = t, r(e))) : A
                }

                function l(e, t) {
                    var n, o;
                    return e ? (o = new i, e.state = o, o.window = null, n = s(e, t), n !== D && (e.state = null), n) : A
                }
                ...
                function f(e, t) {
                    var n, i, a, r, s, l, d, f, h, m, p, b, me, pe, be, we, ge, ve, ke, ye, _e, Se, xe, Me, Ce = 0,
                        Ee = new w.Buf8(4),
                        De = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                    if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return A;
                    n = e.state, n.mode === J && (n.mode = K), s = e.next_out, a = e.output, d = e.avail_out, r = e.next_in, i = e.input, l = e.avail_in, f = n.hold, h = n.bits, m = l, p = d, Se = D;
                    e: for (;;) switch (n.mode) {
                        case O:
                            if (0 === n.wrap) {
                                n.mode = K;
                            ...
                            if (2 & n.wrap && 35615 === f) {
                                n.check = 0, Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0), f = 0, h = 0, n.mode = U;
                                break
                            }
                            ...
                            n.dmax = 1 << _e, e.adler = n.check = 1, n.mode = 512 & f ? G : J, f = 0, h = 0;
                            break;
                        case U:
                            for (; 16 > h;) {
                                if (0 === l) break e;
                            ...
                            n.head && (n.head.text = f >> 8 & 1), 512 & n.flags && (Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0)), f = 0, h = 0, n.mode = P;
                        case P:
                            for (; 32 > h;) {
                                if (0 === l) break e;
                                l--, f += i[r++] << h, h += 8
                        ...
                        case W:
                            if (0 === n.havedict) return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, F;
                    ...
                    return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe, B) : (m -= e.avail_in, p -= e.avail_out, e.total_in += m, e.total_out += p, n.total += p, n.wrap && p && (e.adler = n.check = n.flags ? v(n.check, a, p, e.next_out - p) : g(n.check, a, p, e.next_out - p)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === m && 0 === p || t === M) && Se === D && (Se = z), Se)
                }
            ...
            function(e, t, n) {
                ...
                t.exports = function(e, t, n, m, p, b, w, g) {
                    var v, k, y, _, S, x, M, C, E, D = g.bits,
                        ...
                        H = 0;
                    for (R = 0; i >= R; R++) N[R] = 0;
                    for (F = 0; m > F; F++) N[t[n + F]]++;
                    for (B = D, L = i; L >= 1 && 0 === N[L]; L--);
                    if (B > L && (B = L), 0 === L) return p[b++] = 20971520, p[b++] = 20971520, g.bits = 1, 0;
                    for (A = 1; L > A && 0 === N[A]; A++);
                    for (A > B && (B = A), O = 1, R = 1; i >= R; R++)
                        if (O <<= 1, O -= N[R], 0 > O) return -1;
                    if (O > 0 && (e === s || 1 !== L)) return -1;
                    for (j[1] = 0, R = 1; i > R; R++) j[R + 1] = j[R] + N[R];
                    for (F = 0; m > F; F++) 0 !== t[n + F] && (w[j[t[n + F]]++] = F);
                    if (e === s ? (Z = q = w, x = 19) : e === l ? (Z = u, T -= 257, q = c, H -= 257, x = 256) : (Z = f, q = h, x = -1), P = 0, F = 0, R = A, S = b, z = B, I = 0, y = -1, U = 1 << B, _ = U - 1, e === l && U > a || e === d && U > r) return 1;
                    for (var G = 0;;) {
                        G++, M = R - I, w[F] < x ? (C = 0, E = w[F]) : w[F] > x ? (C = q[H + w[F]], E = Z[T + w[F]]) : (C = 96, E = 0), v = 1 << R - I, k = 1 << z, A = k;
                        do k -= v, p[S + (P >> I) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
                        for (v = 1 << R - 1; P & v;) v >>= 1;
                        if (0 !== v ? (P &= v - 1, P += v) : P = 0, F++, 0 === --N[R]) {
                            if (R === L) break;
                            R = t[n + w[F]]
                        }
                        if (R > B && (P & _) !== y) {
                            for (0 === I && (I = B), S += A, z = R - I, O = 1 << z; L > z + I && (O -= N[z + I], !(0 >= O));) z++, O <<= 1;
                            if (U += 1 << z, e === l && U > a || e === d && U > r) return 1;
                            y = P & _, p[y] = B << 24 | z << 16 | S - b | 0
                        }
                    }
                    return 0 !== P && (p[S + P] = R - I << 24 | 64 << 16 | 0), g.bits = B, 0
                }
            }, {
                "../utils/common": 1
            }
        ...
        "/lib/inflate.js": [
            function(e, t, n) {
                ...
                }, n.Inflate = h, n.inflate = o, n.inflateRaw = i,
                n.ungzip = o
            }, {
                "./utils/common": 1,
                "./utils/strings": 2,
...
function() {
    var e = function(e) {
        ...
        function n() {
            ...
            function m(t) {
                if (t.buffer instanceof ArrayBuffer) t = t.buffer;
                ...
                var a = e.files;
                for (i = 0; i < a.length; ++i) r.prototype.requests[a[i].filename].onload();
                Module.removeRunDependency("datafile_AngryBots.data")
            }

            function p(e) {
                console.error(e), console.error("falling back to default preload behavior"), fetchRemotePackageWrapper(s, l, m, t)
            }
            Module.FS_createPath("/", "Il2CppData", !0, !0), Module.FS_createPath("/Il2CppData", "Metadata", !0, !0), Module.FS_createPath("/", "Resources", !0, !0), Module.FS_createPath("/", "Managed", !0, !0), Module.FS_createPath("/Managed", "mono", !0, !0), Module.FS_createPath("/Managed/mono", "2.0", !0, !0), r.prototype = {
                requests: {},
                open: function(e, t) {
            ...
            var b = e.files;
            for (i = 0; i < b.length; ++i) new r(b[i].start, b[i].end, b[i].crunched, b[i].audio).open("GET", b[i].filename);
            var w = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB,
                ...
                _ = "METADATA",
                S = "PACKAGES";
            Module.addRunDependency("datafile_AngryBots.data"), Module.preloadResults || (Module.preloadResults = {}), u(function(e) {
                c(e, o + a, function(t) {
                    Module.preloadResults[a] = {
                        fromCache: t
                    }, t ? (console.info("loading " + a + " from cache"), f(e, o + a, m, p)) : (console.info("loading " + a + " from remote"), fetchRemotePackageWrapper(s, l, function(t) {
                        h(e, o + a, t, {
                            uuid: d
                        }, m, function(e) {
                            console.error(e), m(t)
    ...
    e({
        ...
        remote_package_size: 44246826,
        package_uuid: "660b10e9-64ec-437a-b9b7-9880bcb07a6a"
    })
}();